...
class TestStory(ATK_Test_Case):
    def setUp(self):
        self.test_obj = Story()
        self.test_element1 = StoryElement(transcript='Test 1', slide=1, next_slide=2, type=SlideType.CONTENT, is_cached=False)
        self.test_element2 = StoryElement(transcript='Test 2', slide=2, next_slide=3, type=SlideType.CONTENT, is_cached=False)
        self.test_element3 = StoryElement(transcript='Test 3', slide=3, next_slide=-1, type=SlideType.CONTENT, is_cached=False)
